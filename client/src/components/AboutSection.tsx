...
import { Users, Trophy, Target, ArrowRight, Quote } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Leading the way in innovative technology solutions with a passion
            for excellence and client success.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              At Flink, we believe in the power of technology to transform
              businesses and create meaningful impact. Our team of skilled
              developers and technology experts specializes in cutting-edge
              solutions that drive innovation and accelerate growth.
            </p>
            <p className="text-muted-foreground mb-6 leading-relaxed">
              From web development and full-stack applications to SAP BTP cloud
              solutions and AI integration, we deliver comprehensive technology
              services that help our clients stay ahead in today's competitive
              landscape.
            </p>
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <blockquote className="text-muted-foreground italic mb-4 leading-relaxed">
                    ...
                    technology solutions that not only meet their current needs
                    but also prepare them for the future. At Flink, we're
        ...
        <div className="bg-muted/30 rounded-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Maintaining the highest standards of quality in every project we
                undertake.
              </p>
            </div>
          </div>

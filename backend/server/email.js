...
/**
 * Sends an email using the SendGrid MailService.
...
/**
 * Creates the email content for a new contact form submission notification.
 * @param {Object} submission - The form submission data.
 * @returns {Object} - The email parameters object.
 */
function createContactNotificationEmail(submission) {
...
/**
 * Creates the auto-reply email content for the user.
 * @param {Object} submission - The form submission data.
 * @returns {Object} - The email parameters object.
 */
function createAutoReplyEmail(submission) {
